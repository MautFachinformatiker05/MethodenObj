...
public class RechteckGefüllt {
	...
	public static void main(String[] args) {
		...
		rechteckGef(MITTE_X, MITTE_Y, BREITE_X, HÖHE_Y);
		
		Array.drucke();
	}

	public static void rechteckGef(final int MITTE_X, final int MITTE_Y, final int BREITE_X, final int HÖHE_Y)
	{
	...
	public static void rechteckDel(final int MITTE_X, final int MITTE_Y, final int BREITE_X, final int HÖHE_Y)
	{
		_x:for (int i=MITTE_X;i<=MITTE_X+BREITE_X;i++)
		{
			if (i>=BREITE || i<0)
